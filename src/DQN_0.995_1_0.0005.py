...
class DQN():
    ...
    def __init__(self, game, retrain = False, epsilon=1, epsilon_decay = 0.995, 
        ...
        self.csv_filename = "/content/drive/MyDrive/Colab Notebooks/DQN-FinalFrontier/1.0_0.0005/1p0_0p0005.csv"
        self.model_filename = "/content/drive/MyDrive/Colab Notebooks/DQN-FinalFrontier/1.0_0.0005/1p0_0p0005.h5"
...
game = "LunarLander-v2"
dqn = DQN(game, retrain = False, epsilon=1 , epsilon_decay = 0.995, epsilon_min = 0.01, batch_size = 64, discount_factor=0.99, episodes=2000, alpha = 1.0, lr=0.0005)
df = dqn.play()
